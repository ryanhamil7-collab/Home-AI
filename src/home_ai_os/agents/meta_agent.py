...
class MetaAgent:
    ...
    def code_agent(self):
        ...
        if self._code_agent is None:
            from home_ai_os.agents.code_agent import get_code_agent
    ...
    def research_agent(self):
        ...
        if self._research_agent is None:
            from home_ai_os.agents.research_agent import get_research_agent
    ...
    def business_agent(self):
        ...
        if self._business_agent is None:
            from home_ai_os.agents.business_agent import get_business_agent
    ...
    def content_agent(self):
        ...
        if self._content_agent is None:
            from home_ai_os.agents.content_agent import get_content_agent
    ...
    def execution_agent(self):
        ...
        if self._execution_agent is None:
            from home_ai_os.agents.execution_agent import get_execution_agent
